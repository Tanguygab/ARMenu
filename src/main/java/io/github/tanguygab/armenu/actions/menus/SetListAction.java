...
public class SetListAction extends Action {

    private final Pattern pattern = Pattern.compile("(?i)set-list:( )?");
    ...
    public String getSuggestion() {
        return "set-list: <list> <first shown index>";
    }
    ...
    public void execute(String match, TabPlayer p) {
        ...
        ((ListItem)item).setCurrentIncrement(p,index);
    }
}
